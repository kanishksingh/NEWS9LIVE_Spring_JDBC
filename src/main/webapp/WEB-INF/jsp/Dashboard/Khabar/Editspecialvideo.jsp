<%-- 
    Document   : Editspecialvideo
    Created on : 15 Jul, 2020, 1:21:45 AM
    Author     : KANISHK
--%>
...
<html lang="en"> 
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input name="videolink" type="text" class="md-input" id="videolink" value="${command.videoLink}" >
                                        </div>
                                        <div class="uk-form-row">
                                            <label>Title</label>
                                            <input name="title" class="md-input" id="title" value="${command.title}">
                                        </div>
                                    </div>
                                    <div class="uk-width-medium-1-2">
                                         <div class="uk-form-row">
                                        ...
                                        <div class="uk-form-row">
                                         ...
                                         <div class="uk-form-row">
                                           <input name="ssno" type="hidden" class="md-input" id="ssno" value="${command.sno}">

                                             <button name="submit" class="md-btn" id="submit" value="">Update</button>
                                        </div>
                                    </div>
                                </div>
                                    <hr>
   ...
   <hr style="    border: 1px solid;">
        ...
        <script>
           function Report() {
               document.getElementById("publish").value='${command.status}';
...
var integer=index + 1;
    ...
    if (doSave) {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/UpdateSpecialVideo',
            type: 'POST',
            data: formDat,
            cache: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                alert("Video Detail Updated successfully");
