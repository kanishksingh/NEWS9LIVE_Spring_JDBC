      ...
      <div class="top-menu bg-four">
        <div class="container">
          ...
          <nav class="navbar navbar-expand-lg navbar-dark px-0 py-0">
            ...
            <!-- Mobile logo -->
            <a href="index.html">
              <img class="mobile-logo img-fluid d-lg-none mx-auto" src="${pageContext.request.contextPath}/resources/images/news9india.png" alt="Logo site">
            </a>
            <!--Right Toggle Button-->
            ...
            <div class="col-lg-4">
              <div id="main-logo" class="main-logo my-2 my-lg-4 d-none d-lg-block">
                <a class="navbar-brand" href="index.jsp">
                  <img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/news9india.png" alt="Logo site">
                </a>
              </div>
            </div>
            <!--Right content ads-->
